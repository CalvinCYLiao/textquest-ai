...
window.PRESET_ACTIVITIES = [
    ...
    },
    {
        ...
        sourceText: `1. 桃園台地過去有「千塘之鄉」的美名，埤塘具有蓄水灌溉、滯洪防災及調節氣候的重要生態功能。\n2. 為了推動再生能源，部分埤塘鋪設了水面型太陽光電板，宣稱能增加綠能發電並減少水份蒸發。\n3. 生態志工觀測發現，光電板覆蓋水面阻擋陽光照入，稀有保育植物「台灣萍蓬草」因缺乏光照而枯萎。\n4. 野鳥學會的調查指出，大面積的太陽能板阻礙了冬候鳥降落與覓食，導致該區冬候鳥數量減少了五成。\n5. 光電開發商強調，發電設施僅佔用埤塘三分之一的水域，且採用無毒浮力材料，符合國家綠能規範。\n6. 灌溉小組長表示，光電板底下因水流停滯，導致藻類與青苔快速孳生，可能影響下游農田的灌溉水質。\n7. 永續生態專家建議，應避開冬候鳥重要棲地，建立生態敏感區地圖，並使用高透光性的光電浮力模組。`,
        locations: [
            {
                id: 'loc_pond_site',
                icon: '🦆',
    ...
    },
    {
        ...
        sourceText: `1. 桃園大圳是北台灣最重要的農田灌溉系統，支流交錯，但大圳沿線近年設立了許多金屬化工廠。\n2. 大圳下游灌溉區的菜農發現，渠道內的水有時會呈現混濁的紅褐色，且澆灌後的蔬菜葉片會出現焦枯斑點。\n3. 鄰近的化工廠發表公開聲明，保證生產廢水全部經由專用廢水設備處理，排放的「雨水溝」完全符合安全標準。\n4. 環保局稽查大隊的自動水質監測器顯示，該支流的重金屬銅離子（Cu）濃度與電導度在半夜常有異常飆高現象。\n5. 環境志工在工廠後門的雨水排放管處採集樣本，使用檢測包驗出水質呈強酸性（pH值低於4.5），懷疑工廠將廢水偷排至雨水溝。\n6. 化工廠離職員工透露，工廠內部為了省下廢水處理化學藥劑的昂貴費用，有時會趁雨天或半夜將未處理廢水直接抽排至雨水溝。\n7. 農業改良場專家警告，灌溉水中的重金屬會被蔬菜吸收累積，一旦進入營養午餐食材，將嚴重危害學童與市民健康。`,
        locations: [
            {
                id: 'loc_canal_branch',
                icon: '🌊',
    ...
    },
    {
        ...
        sourceText: `1. 石門水庫主要供應桃園大圳農業灌溉，同時供應桃園與新北地區數百萬人的民生與工業用水。\n2. 受到全球氣候變遷影響，梅雨與颱風降雨不足，石門水庫的蓄水率跌破兩成，面臨嚴重缺水危機。\n3. 政府為了保障民生與龍潭、科學園區半導體廠的運作，宣布大圳灌溉區停灌休耕，並給予農民補償金。\n4. 桃園大溪的稻農對休耕政策表示抗議，強調長期停灌會導致肥沃農田土地鹽化，且冠軍米品種面臨失傳。\n5. 高科技半導體廠代表說明，晶圓製造製程一天的耗水量極大，若限水停工將造成數十億元的國際訂單與經濟損失。\n6. 水資源局調配報告指出，桃園大圳大部分圳路為泥土渠道，輸送過程中因為滲漏與泥沙淤積，漏水率高達25%。\n7. 永續水利專家指出，除了休耕補償，應加速圳路防漏水泥化，並強制高科技廠提高製程回收水利用率至90%。`,
        locations: [
            {
                id: 'loc_shimen_dam',
                icon: '⛰️',
